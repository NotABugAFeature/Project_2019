...
/**
 * Implements the join of two relations
 ...
 * @return an integer code {0,1,2}
 */
int final_join_parallel(middle_list* list_t, middle_list* list_s, relation *t, relation *s, uint64_t start_t, uint64_t end_t, uint64_t start_s)
{
